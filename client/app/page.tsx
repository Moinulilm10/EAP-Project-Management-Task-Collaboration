      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-gutter">
        ...
        <Card className="h-full">
          ...
          <h3 className="font-title-md text-title-md text-on-surface mb-xs">
            {t("Q3 Marketing Campaign")}
          </h3>
          <p className="font-body-md text-body-md text-secondary line-clamp-2 mb-md flex-1">
            {t("Executing the multi-channel marketing strategy for the new product launch across digital platforms.")}
          </p>
          <div className="mt-auto">
            <div className="flex justify-between items-center mb-xs font-label-sm text-label-sm">
              <span className="text-secondary flex items-center gap-xs">
                <span className="material-symbols-outlined text-[14px]">{t("calendar_today")}</span> {t("Oct 15")}
              </span>
        ...
        <Card className="h-full">
          ...
          <h3 className="font-title-md text-title-md text-on-surface mb-xs">
            {t("Client Portal Redesign")}
          </h3>
          <p className="font-body-md text-body-md text-secondary line-clamp-2 mb-md flex-1">
            {t("Overhauling the user interface and experience for the primary enterprise client dashboard.")}
          </p>
          <div className="mt-auto">
            <div className="flex justify-between items-center mb-xs font-label-sm text-label-sm">
              <span className="text-error flex items-center gap-xs font-bold">
                <span className="material-symbols-outlined text-[14px]">{t("warning")}</span> {t("Tomorrow")}
              </span>
        ...
        <Card className="h-full opacity-75 hover:opacity-100">
          <div className="flex justify-between items-start mb-sm">
            <Badge variant="completed">{t("Completed")}</Badge>
            <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-xs">
              <button className="p-1 text-secondary hover:text-primary rounded hover:bg-surface-container-high transition-colors">
                <span className="material-symbols-outlined text-[18px]">{t("edit")}</span>
              </button>
          ...
          <h3 className="font-title-md text-title-md text-on-surface mb-xs">
            {t("Server Migration V2")}
          </h3>
          <p className="font-body-md text-body-md text-secondary line-clamp-2 mb-md flex-1">
            {t("Migrated legacy databases to the new cloud infrastructure with zero downtime.")}
          </p>
          <div className="mt-auto">
            <div className="flex justify-between items-center mb-xs font-label-sm text-label-sm">
              <span className="text-secondary flex items-center gap-xs">
                <span className="material-symbols-outlined text-[14px]">{t("check_circle")}</span> {t("Sep 01")}
              </span>
